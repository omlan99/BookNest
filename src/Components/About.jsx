...
const About = () => {
  return (
      ...
      <div className="grid lg:grid-cols-2 text-left gap-10 px-5 mt-[100px] pt-[100px] py-5" id="about">
        <div className="space-y-5 my-auto order-last lg:order-first">
          <h3 className="font-medium text-3xl">What We Have To Offer</h3>
          <div>
            <h6 className="font-semibold text-2xl py-2">Selection</h6>
            <p>
          ...
          <div>
            <h6 className="font-semibold text-2xl py-2">Borrowing Power</h6>
            <p>
          ...
          <div>
            <h6 className="font-semibold text-2xl py-2">FREE Shipping & More</h6>
            <p>
